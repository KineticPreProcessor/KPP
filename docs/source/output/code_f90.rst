...
.. list-table:: Global Variables Declared in ROOT_Global
   ...
   * - :code:`CFACTOR`
     - Conversion factor
   * - :code:`NonPassiveSpc_Count`
     - Number of :non-passive species (cf. :ref:`filter-passive-spc`)
   * - :code:`NonPassiveSpc_Indices`
     - List of species indices for only the non-passive species
