\def\myfiledate{2022-04-20} % "\myfiledate" because packages may change \filedate
...
\code{ICNTRL_U(15)} & This determines which \code{Update_*} subroutines
                    ...
                    \begin{tabular}{lp{10cm}}
                      ...
                      0:    & Call all \code{Update_*} subroutines (default)\\
                    ...
                    \end{tabular}\par
                    For example, \code{ICNTRL_U(15)=6} will activate the
