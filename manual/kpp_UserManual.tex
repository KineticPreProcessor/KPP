...
%-----------------------------------------------------------------------------
\subsubsection{Generate Fortran-90 files with the {\tt\.F90} suffix ({\tt\#UPPERCASEF90})}
...
{\tt\#UPPERCASEf90 on} will tell KPP to generate Fortran-90 code
ending in {\tt\.F90} instead.  
...
{\it command} ::=  & \code{#CHECKALL}                                                    & $|$\\
                   ...
                   & \code{#INTEGRATOR} {\it integrator\_name}                   pr        & $|$\\
...
{\it inline\_type} ::=              & \code{F90_RATES} $|$ \code{F90_RCONST} $|$ \code{F90_GLOBAL} $|$
                                    ...
                                    & \code{MATLAB_INIT} $|$ \code{MATLAB_DATA} $|$ \code{MATLAB_UTIL}\\[1.5mm]qq
