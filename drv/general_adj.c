//=========================================================================
// general_adj.c -- KPP "box model" adjoint driver program for C
//=========================================================================
...
int main() {
  ...
  // Tolerances for calculating adjoints are used for controlling adjoint
  // truncation error and for solving the linear adjoint equations by
  // iterations. Note: Adjoints typically span many orders of magnitude
  ...
  // Initialize Y_adj, the adjoint values at the final time */
  for(i=0; i<NADJ; i++) {
    for(j=0; j<NVAR; j++)
  ...
  // Write MONITOR information to file
  SaveData();
