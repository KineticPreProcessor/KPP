...
! JACSPDB arrays and parameters.
  ...
  KPP_REAL, ALLOCATABLE, PRIVATE :: YSCALEDS(:), WKDS(:), FACDS(:)
  KPP_REAL, PRIVATE :: U125, U325
!_______________________________________________________________________
...
!_______________________________________________________________________
      KPP_REAL, PARAMETER, PRIVATE :: ADDON = 1.0E-6_dp
      KPP_REAL, PARAMETER, PRIVATE :: BIAS1 = 6.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: BIAS2 = 6.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: BIAS3 = 10.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: CCMAX = 0.3_dp
      KPP_REAL, PARAMETER, PRIVATE :: CORTES = 0.1_dp
      KPP_REAL, PARAMETER, PRIVATE :: CRDOWN = 0.3_dp
      KPP_REAL, PARAMETER, PRIVATE :: ETACF = 0.25_dp
      KPP_REAL, PARAMETER, PRIVATE :: ETAMIN = 0.1_dp
      KPP_REAL, PARAMETER, PRIVATE :: ETAMX1 = 1.0E4_dp
      KPP_REAL, PARAMETER, PRIVATE :: ETAMX2 = 10.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: ETAMX3 = 10.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: ETAMXF = 0.2_dp
      KPP_REAL, PARAMETER, PRIVATE :: FIVE = 5.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: FOUR = 4.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: HALF = 0.5_dp
      KPP_REAL, PARAMETER, PRIVATE :: HUN = 100.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: HUNDRETH = 0.01_dp
      KPP_REAL, PARAMETER, PRIVATE :: ONE = 1.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: ONEPSM = 1.00001_dp
      KPP_REAL, PARAMETER, PRIVATE :: PT1 = 0.1_dp
      KPP_REAL, PARAMETER, PRIVATE :: PT2 = 0.2_dp
      KPP_REAL, PARAMETER, PRIVATE :: RDIV = 2.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: SIX = 6.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: TEN = 10.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: TENTH = 0.1_dp
      KPP_REAL, PARAMETER, PRIVATE :: THOU = 1000.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: THRESH = 1.5_dp
      KPP_REAL, PARAMETER, PRIVATE :: TWO = 2.0_dp
      KPP_REAL, PARAMETER, PRIVATE :: ZERO = 0.0_dp
...
! .. Derived Type Declarations ..
      TYPE, PUBLIC :: VODE_OPTS
        KPP_REAL, DIMENSION (:), POINTER :: ATOL, RTOL
...
!     For communication with subroutine ma48_control_array:
      KPP_REAL, PUBLIC :: COPY_OF_U_PIVOT
!_______________________________________________________________________
      KPP_REAL, PRIVATE :: ACNRM, ALPHA, BIG, BIG1, CCMXJ, CGCE, CONP, CRATE,  &
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      INTEGER  :: IA(LU_NONZERO), JA(LU_NONZERO)
#endif   
...
! RUSER  = A real working array (KPP_REAL).
...
! .. Subroutine Interfaces ..
     ...
     INTERFACE
       SUBROUTINE G_FCN(NEQ,T,Y,NG,GROOT)
         ...
         KPP_REAL, DIMENSION(NG) :: GROOT(NG)
...
! ..
! .. Scalar Arguments ..
        KPP_REAL, OPTIONAL, INTENT (IN) :: HMAX, HMIN
...
! RELERR                 - KPP_REAL scalar
! ABSERR                 - KPP_REAL scalar
! ABSERR_VECTOR          - KPP_REAL vector
! NEVENTS                - integer
! Options:
...
! ..
! .. Scalar Arguments ..
        KPP_REAL, OPTIONAL, INTENT (IN) :: ABSERR,RELERR
...
! ..
! .. Array Arguments ..
        KPP_REAL, OPTIONAL, INTENT (IN) :: ABSERR_VECTOR(:)
! ..
! .. Local Scalars ..
...
! ABSERR                 - KPP_REAL scalar
! ABSERR_VECTOR          - KPP_REAL vector
! TCRIT                  - KPP_REAL scalar
! H0                     - KPP_REAL scalar
! HMAX                   - KPP_REAL scalar
! HMIN                   - KPP_REAL scalar
! MAXORD                 - integer
! MXSTEP                 - integer
! MXHNIL                 - integer
! NZSWAG                 - integer
...
! CLOWER                 - KPP_REAL array
! CUPPER                 - KPP_REAL array
...
!                     messages.
!   MA28_EPS        = KPP_REAL MA28 singularity threshold
!
!                         All Options
!
! METHOD_FLAG
...
! ..
! .. Scalar Arguments ..
        KPP_REAL, OPTIONAL, INTENT (IN) :: ABSERR, H0, HMAX, HMIN,         &
        RELERR, TCRIT
...
! .. Array Arguments ..
        KPP_REAL, OPTIONAL, INTENT (IN) :: ABSERR_VECTOR(:)
        KPP_REAL, OPTIONAL :: CLOWER(:), CUPPER(:)
...
! MXHNIL                 - integer
! YMAGWARN               - logical
! SETH                   - KPP_REAL scalar
! UPIVOT                 - KPP_REAL scalar
! NZSWAG                 - integer
! USER_SUPPLIED_SPARSITY - logical
! NEVENTS                - integer
! CONSTRAINED            - integer array
...
! ..
! .. Array Arguments ..
        KPP_REAL, OPTIONAL, INTENT (IN) :: ABSERR_VECTOR(:), RELERR_VECTOR(:)
        KPP_REAL, OPTIONAL :: CLOWER(:), CUPPER(:)
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: RSTATS(22)
...
!     call to SET_OPTS.
!     Usage:
!     CALL (IAUSER,NIAUSER,JAUSER,NJAUSER)
!       In this case, IAUSER of length NIAUSER will be used for
!       IA; and JAUSER of length NJAUSER will be used for JA.
!     Arguments:
!     IAUSER  = user supplied IA array
...
! ..
! .. Local Scalars ..
        KPP_REAL :: AIJ, DTRB, EMIN, RJ, YJ, YJSAVE, YPJ
...
! ..
! .. Local Scalars ..
        KPP_REAL :: ATOLI, BIG, EWTI, H0, HMAX, HMX, RH, RTOLI, SIZEST, &
...
! ..
! .. Scalar Arguments ..
        KPP_REAL, INTENT (INOUT) :: H0
        KPP_REAL, INTENT (IN) :: T0, TOUT
        INTEGER :: IER
        INTEGER, INTENT (IN) :: ITOL, N
        INTEGER, INTENT (INOUT) :: NITER
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (IN) :: ATOL(*), EWT(*), Y0(*)
        KPP_REAL, INTENT (INOUT) :: TEMP(*), Y(*), YDOT(*)
! ..
! .. Subroutine Arguments ..
        EXTERNAL F
! ..
! .. Local Scalars ..
        KPP_REAL :: AFI, ATOLI, DELYI, H, HG, HLB, HNEW, HRAT, HUB, T1, &
          TDIST, TROUND, YDDNRM
        INTEGER :: I, ITER
! ..
! .. Intrinsic Functions ..
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: DKY(*), YH(LDYH,*)
! ..
! .. Local Scalars ..
        KPP_REAL :: C, R, S, TFUZZ, TN1, TP
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: ACOR(*), EWT(*), SAVF(*), &
          WM(*), Y(*), YH(LDYH,*), YH1(*)
        KPP_REAL, INTENT (IN) :: ATOL(*)
...
! ..
! .. Local Scalars ..
        KPP_REAL :: CNQUOT, DDN, DSM, DUP, ETAQ, ETAQM1, ETAQP1, FLOTL, R, &
          TOLD
...
! ..
! .. Local Scalars ..
        KPP_REAL :: AHATN0, ALPH0, CNQM1, CSUM, ELP, EM0, FLOTI, FLOTL, &
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: YH(LDYH,*)
! ..
! .. Local Scalars ..
        KPP_REAL :: ALPH0, ALPH1, HSUM, PROD, T1, XI, XIOLD
...
! ..
! .. Local Scalars ..
        KPP_REAL :: ACNRMNEW, CSCALE, DCON, DEL, DELP
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: EWT(*), FTEM(*), SAVF(*), WM(*), &
          Y(*),YH(LDYH,*)
        KPP_REAL, INTENT (IN) :: ATOL(*)
        INTEGER, INTENT (INOUT) :: IWM(*)
! ..
...
! ..
! .. Local Scalars ..
        KPP_REAL :: CON, DI, FAC, HRL1, R, R0, SRUR, YI, YJ, YJJ
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (IN) :: A(NROWA,NCOL)
        KPP_REAL, INTENT (INOUT) :: B(NROWB,NCOL)
! ..
! .. Local Scalars ..
        INTEGER :: IC
! ..
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: WM(*), X(*)
        INTEGER, INTENT (INOUT) :: IWM(*)
! ..
! .. Local Scalars ..
        KPP_REAL :: DI, HRL1, PHRL1, R
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (IN) :: ATOL(*), RTOL(*), YCUR(N)
        KPP_REAL, INTENT (OUT) :: EWT(N)
! ..
! .. Intrinsic Functions ..
        INTRINSIC ABS
! ..
...
!  4. R1 and R2 are assumed to be in KPP_REAL and are printed
!     in D21.13 format.
! Internal Notes:
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: EWT(*), Y(*)
        KPP_REAL :: SAVF(*)
        KPP_REAL, INTENT (IN) :: YH(LDYH,*)
! ..
! .. Subroutine Arguments ..
        EXTERNAL F, JAC
! ..
! .. Local Scalars ..
        KPP_REAL :: DQ, DYJ, ERWT, FAC, YJ
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: EWT(*), SAVF(*), Y(*)
! ..
! .. Subroutine Arguments ..
        EXTERNAL F
! ..
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: BINCL(*), BJA(*), BDONE(*)
! ..
! .. Local Scalars ..
        INTEGER :: I, IBDONE, IBINCL, IER, J, K, KBEGIN, KFINI, &
          KI, KJ, MAXG, NCOL, NG
        KPP_REAL :: FUDGE, ONE_PLUS_FUDGE
        CHARACTER (80) :: MSG
! ..
! .. Intrinsic Functions ..
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: EWT(*), FTEMP1(*), SAVF(*), Y(*), YH(LDYH,*)
        KPP_REAL, INTENT (IN) :: ATOL(*)
! ..
! .. Subroutine Arguments ..
        EXTERNAL F, JAC
! ..
! .. Local Scalars ..
        KPP_REAL :: CON, FAC, HRL1, R, R0, SRUR
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: G0(*), G1(*), GX(*), Y(*), YH(NYH,*)
! ..
! .. Subroutine Arguments ..
        EXTERNAL G
! ..
! .. Local Scalars ..
        KPP_REAL :: HMING, T1, TEMP1, TEMP2, X
...
! ..
! .. Scalar Arguments ..
        KPP_REAL, INTENT (IN) :: HMIN
        KPP_REAL, INTENT (INOUT) :: X, X0, X1
...
! ..
!     DGEFA_F90 factors a KPP_REAL matrix by Gaussian elimination.
...
! ..
!     DGESL_F90 solves the KPP_REAL system
...
! ..
!     DGBFA_F90 factors a KPP_REAL band matrix by elimination.
...
! ..
!     DGBSL_F90 solves the KPP_REAL band system
!     A * X = B or TRANS(A) * X = B
...
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (INOUT) :: ABD(LDA,*), B(*)
        INTEGER, INTENT (INOUT) :: IPVT(*)
! ..
! .. Local Scalars ..
        KPP_REAL :: T
...
!     DA   - KPP_REAL scalar multiplier
!     DX   - KPP_REAL vector with N elements
!     INCX - storage spacing between elements of DX
!     DY   - KPP_REAL vector with N elements
!     INCY -  storage spacing between elements of DY
!     Output:
!     DY - KPP_REAL result (unchanged if N <= 0)
!     Overwrite KPP_REAL DY with KPP_REAL DA*DX + DY.
...
! ..
! .. Scalar Arguments ..
        KPP_REAL, INTENT (IN) :: DA
        INTEGER, INTENT (IN) :: INCX, INCY, N
! ..
! .. Array Arguments ..
        KPP_REAL, INTENT (IN) :: DX(*)
        KPP_REAL, INTENT (INOUT) :: DY(*)
! ..
! .. Local Scalars ..
...
!     Copy KPP_REAL DX to KPP_REAL DY.
...
!     INCY - storage spacing between elements of DY
!     Output:
!     DDOT_F90 - KPP_REAL dot product (zero if N <= 0)
!     Returns the dot product of KPP_REAL DX and DY.
...
!     Input:
!     N    - number of elements in input vector(s)
!     DA   - KPP_REAL scale factor
!     DX   - KPP_REAL vector with N elements
!     INCX - storage spacing between elements of DX
!     Output:
!     DX - KPP_REAL result (unchanged if N <= 0)
!     Replace KPP_REAL DX by KPP_REAL DA*DX.
...
!     Find smallest index of maximum magnitude of KPP_REAL DX.
...
! ..
! .. Array Arguments ..
        KPP_REAL :: A(LICN), AORG(NZ), R(N), RHS(N), W(N), X(N)
        INTEGER :: ICN(LICN), ICNORG(NZ), IKEEP(N,5), IRNORG(NZ)
! ..
! .. Local Scalars ..
        KPP_REAL :: CONVER, D, DD
...
! ..
! .. Local Scalars ..
        KPP_REAL :: AANEW, AMAX, ANEW, AU, PIVR, PIVRAT, SCALE
...
! ..
! .. Array Arguments ..
        KPP_REAL :: A(NA), C(N), R(N), W(N,5)
        INTEGER :: ICN(NA), IRN(NA)
! ..
! .. Local Scalars ..
        KPP_REAL :: E, E1, EM, Q, Q1, QM, S, S1, SM, SMIN, U, V
...
! ..
! .. Array Arguments ..
      KPP_REAL :: F(N), FAC(N), FJAC(NRFJAC,*), WK(LWK), Y(N), YSCALE(*)
...
! ..
! .. Local Scalars ..
      KPP_REAL :: ADIFF, AY, DEL, DELM, DFMJ, DIFF, DMAX, EXPFMN, FACMAX, &
